...
# Please ensure you are in the correct virtual environment in order for the following imports to work
...
def calculatePermutation(nodes, pos_to_node, dec):
    arr = []
...
def findSymmetry(filename):
    pos_to_node = readFile(filename)
    # The amount of decimals this algorithm compares
    dec = 4
