...
export default class LineTo extends Component {
  ...
  componentDidMount() {
    ...
    dashboard.addEventListener("scroll", this.handleDashboardScroll);
  }
  ...
  componentWillUnmount() {
    ...
    document.getElementById("modules-dashboard").removeEventListener("scroll", this.handleDashboardScroll);
  }
